...
def test_save_working_without_inputs_snapshot_raises_domain_error(monkeypatch):
    """
    Policy: manual save_working MUST fail if existing working has no inputs_snapshot.
    """
